...
class WidgetCode extends Widget
{
    use WithFileUploads;
    ...
    public function render()
    {
        ...
        if(!$this->viewFile) {
            $this->viewFile = 'jiny-widgets::code.layout';
        }
    ...
    {
        if(!$this->viewList) {
            $this->viewList = 'jiny-widgets::code.html.main';
        }
    }
    ...
    {
        if(!$this->viewForm) {
            $this->viewForm = "jiny-widgets::code.html.form";
        }
    }
